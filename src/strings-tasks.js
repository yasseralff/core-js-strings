...
function encodeToRot13(str) {
  return str.replace(/[a-zA-Z]/g, (char) => {
    ...
    const shift = code <= 90 ? 65 : 97; // Determine ASCII range (uppercase or lowercase)
...
function getCardId(value) {
  ...
  const sym = ['♣', '♦', '♥', '♠'];
  return cha.indexOf(value.slice(0, -1)) + sym.indexOf(value.slice(-1)) * 13;
}
